                                                ...
                                                <figure>
                                                    <div class="snipcart-item block" >
                                                        <div class="snipcart-thumb">
                                                            <a href="{{ route('product-details',['id'=>$product->id,'name'=>$product->product_name ]) }}"><img title=" " alt=" " src="{{ asset($product->product_image ) }}" height="200"  /></a>
                                                            <a href="{{ route('product-details',['id'=>$product->id,'name'=>$product->product_name ]) }}"><p>{{ $product->product_name  }}</p></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <a href=""> <img class="first-slide" src="{{ asset('/') }}/front/images/b1.jpg" alt="First slide"></a>

            </div>
            <div class="item">
                <a href=""> <img class="second-slide " src="{{ asset('/') }}/front/images/b3.jpg" alt="Second slide"></a>

            </div>
            <div class="item">
                <a href=""><img class="third-slide " src="{{ asset('/') }}/front/images/b1.jpg" alt="Third slide"></a>
